...
HELLPIC = (
    PMPERMIT_PIC
    if PMPERMIT_PIC
    else "https://i.ibb.co/Swvg82s/IMG-20201029-205430-067.jpg"
)
PM_WARNS = {}
PREV_REPLY_MESSAGE = {}
myid = bot.uid
...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "Alpha Usêr"
...
USER_BOT_NO_WARN = (
    "Hello, This is **Alphaẞø† Úl†rã Pr¡va†e Security Protocol⚠️**.\n"
        ...
        if len(APPROVED_PMs) > 4095:
            with io.BytesIO(str.encode(APPROVED_PMs)) as out_file:
                ...
                await event.client.send_file(
                    ...
                    force_document=True,
                    allow_cache=False,
                    caption="[AlphaBot]Current Approved PMs",
                    reply_to=event,
                )
                await event.delete()
        else:
